...
export function useOllamaStatus(): BackendResource<OllamaStatus> {
  return useBackendResource<OllamaStatus>(backendApi.getOllamaStatus, "ollama-status");
}

/** Locally installed Ollama models (via the backend). */
export function useOllamaModels(): BackendResource<OllamaModelsResponse> {
  return useBackendResource<OllamaModelsResponse>(backendApi.getOllamaModels, "ollama-models");
}
...
export function useRecommendedModels(): BackendResource<RecommendedModelsResponse> {
  return useBackendResource<RecommendedModelsResponse>(backendApi.getRecommendedModels, "ollama-recommended");
}
